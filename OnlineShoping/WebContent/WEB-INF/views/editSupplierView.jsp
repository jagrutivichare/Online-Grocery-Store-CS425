...
<body>
	...
	<form method="POST" 
		action="doEditSupplier">
		<table border="0">
		    <tr>
				<td>Supplier ID</td>
				<td><input type="text" required="required" readonly="readonly" name="supplierID" value="${supplier.supplierID}" /></td>
			</tr>
			<tr>
				<td>Supplier Name</td>
			...
			<tr>
				<td colspan="2">Address<input type=text name=addressID required="required" style="display: none"
					value="${supplier.address.addressID}"></td>
			</tr>
