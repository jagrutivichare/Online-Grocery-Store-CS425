...
<body>
	...
	<form method="POST" 
		action="doEditWareHouse">
		<table border="0">
		    <tr>
				<td>Warehouse Name</td>
				<td><input type="text" readonly="readonly" required="required" name="warehouseName" value="${warehouse.warehouseName}" /></td>
			</tr>
			<tr>
				<td>Capacity</td>
			...
			<tr>
				...
				<input type=text name=addressID required="required" style="display: none"
					value="${warehouse.address.addressID}"></td>
			</tr>
